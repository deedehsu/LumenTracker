...
// No top-level Store import here, it will be dynamically imported inside app.whenReady()
...
app.whenReady().then(async () => {
    try {
        ...
        const Store = (await import('electron-store')).default; // Dynamically import Store
        store = new Store();
